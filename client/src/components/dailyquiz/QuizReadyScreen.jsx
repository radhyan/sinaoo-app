  ...
  return (
    <div className="min-h-screen bg-w-lb flex items-center justify-center p-6">
      ...
      <div className="max-w-lg w-full space-y-4">
        <div className="bg-white rounded-lg shadow-blue-60 border border-Primary-50 p-6 w-full text-center space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-700">
