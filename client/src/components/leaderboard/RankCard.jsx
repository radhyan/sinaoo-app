  ...
  return (
    <div
      className={cn(
        ...
        isHighlight
          ? "bg-db-b text-white shadow-blue-60 border border-Primary-50"
    ...
    >
      ...
      <div className="flex-1 flex flex-col items-start">
        <p
          className={cn(
            ...
            isHighlight ? "text-Primary-50" : "!text-body-l text-Grayscale-900",
          )}
        >
      ...
      <div className="flex items-center gap-2 shrink-0 ml-4">
        ...
        <StarIcon
          weight="fill"
          size={24}
          className={isHighlight ? "text-Secondary-300" : "text-Secondary-400"}
        />
      </div>
    </div>
  );
